 ...
 <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <ul class="navbar-nav mr-bar">
        ...
        <li class="nav-item">
          <a class="nav-item nav-link active let" href="../pag/delivery.html">Delivery</a>
        </li>
...
<div class="bg-danger esp div container ta">
...
<?php  
  ...
  while ($tb = mysqli_fetch_array($resulta)) {
    echo "<tbody>
      <tr>
          <td>".$tb['nome'];"</td>";
    echo "<td>".$tb['rua'];"</td>";
    echo "<td>".$tb['bairro'];"</td>";
    echo "<td>".$tb['tipo_pizza'];"</td>";
    echo "<td>".$tb['tam'];"</td>";
    "</tr>";
  }
?>
