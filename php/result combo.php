<?php 
  ...
  require_once '../config/selec_comb.php';
?> 
<!DOCTYPE html>
<html>
<head>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <ul class="navbar-nav mr-bar">
        <a class="nav-item nav-link active let" href="../index.html">Home <span class="sr-only">(Página atual)</span></a>

        <li class="nav-item">
          <a class="nav-link let" href="../pag/cardapio.html">Cardapio</a>
        </li>
...
<div class="container bg-danger esp div ta">
	<p class="text-center text-white fonte">Meus Combos</p>
</div>
