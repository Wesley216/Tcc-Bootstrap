...
if (isset($_POST['nome']) && isset($_POST['tel']) && isset($_POST['bair']) && isset($_POST['rua']) && isset($_POST['num']) == 'nome'.'tel'.'bair'.'rua'.'num') {
    ...
    if (!is_string($_POST['nome']) || is_numeric($_POST['nome']) || empty($_POST['nome']) && empty($_POST['rua']) && !is_numeric($_POST['tel']) || empty($_POST['tel']) && !is_string($_POST['bair']) || empty($_POST['bair']) && !is_string($_POST['num']) || empty($_POST['num'])){

        echo "Preencha os campos corretamente."."<br>";
		echo "<a href='../../../pag/Promoção/Logs/cad_promo.html'>Voltar</a>";
    ...
    if ($res > 0) {
		...
		echo "<a href='../../../pag/Promoção/Logs/login_promo.html'>Voltar</a>";
